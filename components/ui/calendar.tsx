...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-2 [--cell-radius:var(--radius-md)] [--cell-size:2.5rem] bg-background group/calendar in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
